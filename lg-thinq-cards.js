...
const cssUrl = new URL('7segment.css', import.meta.url);
const styleElement = document.createElement('link');
styleElement.setAttribute('rel', 'stylesheet');
styleElement.setAttribute('href', cssUrl.href);
...
const cardTypes = {
    'washer': {
        ...
        preview: true,
        documentationURL: 'https://github.com/your-github/lg-washer-dryer-card',
